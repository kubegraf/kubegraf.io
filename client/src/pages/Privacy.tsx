    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-20">
        ...
        >
          ...
          <div className="prose prose-invert max-w-none space-y-4 sm:space-y-6 text-muted-foreground leading-relaxed">
            <p>
              This policy explains what data KubeGraf collects, how it's used, and what choices you have.
            </p>

            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">What data KubeGraf does NOT collect</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">What data is collected</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">How data is used</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">Data storage and retention</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">Third-party services</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">User choices and control</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">Changes to this policy</h2>
            <p>
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-foreground mt-8 mb-4">Contact</h2>
            <p>
