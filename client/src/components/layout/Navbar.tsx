...
const resourcesItems = [
  ...
  { label: "Community", href: LINKS.DISCORD_URL, icon: DiscordIcon, description: "Join us on Discord" },
          ...
          <div className="grid grid-cols-[1fr_auto_1fr] items-center h-full">
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Join KubeGraf Discord Community"
                ...
                whileHover={{ background: '#4752c4', scale: 1.02 } as any}
                whileTap={{ scale: 0.98 }}
              >
            ...
            <div className="pt-20 sm:pt-24 px-6 pb-6 h-full overflow-y-auto">
              ...
              <div className="pt-6 border-t border-border space-y-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full flex items-center justify-center gap-2 h-12 text-base font-semibold rounded-lg"
