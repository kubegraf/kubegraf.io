    ...
    <section className="relative py-12 sm:py-16 lg:py-20 border-t border-border/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 mb-10 sm:mb-12">
          ...
          <p className="text-lg sm:text-xl text-foreground/85 lg:max-w-xs lg:text-right leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
          {anchors.map((anchor) => (
            <div key={anchor.title} className="border-l-2 border-primary/30 pl-6">
              ...
              <ul className="space-y-3">
                {anchor.statements.map((statement, idx) => (
                  <li key={idx} className="flex items-center gap-2 text-base sm:text-lg text-muted-foreground">
        ...
        <div className="mt-10 sm:mt-12">
          <p className="text-xs sm:text-sm text-muted-foreground font-mono border-t border-border/50 pt-6 sm:pt-7">
