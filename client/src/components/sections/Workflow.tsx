      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="relative glass rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-xs font-mono text-orange-400">INCIDENT DETECTED</span>
                  </div>
                  <div className="text-2xl font-mono font-bold">3</div>
                  <div className="text-xs text-muted-foreground">CrashLoopBackOff</div>
                </motion.div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="flex-1 space-y-8">
            ...
            >
              Designed for <br />
              <span className="text-gradient-primary">Human Judgment</span>
            </motion.h2>
